 ...
 * @property-read SchemaTypeList<Text|URL|DigitalPlatformEnumeration> $actionPlatform    The high level platform(s) where the Action can be performed for the given URL. To specify a specific application or operating system instance, use actionApplication.
