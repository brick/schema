 ...
 * @property-read SchemaTypeList<Vehicle|Text>        $aircraft                The kind of aircraft (e.g., "Boeing 747").
 ...
 * @property-read SchemaTypeList<Duration|Text>       $estimatedFlightDuration The estimated time the flight will take.
