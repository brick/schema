 ...
 * @property-read SchemaTypeList<Text|URL|Boolean> $acceptsReservations Indicates whether a FoodEstablishment accepts reservations. Values can be Boolean, an URL at which reservations can be made or (for backwards compatibility) the strings ```Yes``` or ```No```.
 ...
 * @property-read SchemaTypeList<Menu|Text|URL>    $hasMenu             Either the actual menu as a structured representation, as text, or a URL of the menu.
 */
